...
function filterThisMessage(neutralMessage, nick, html_encode) {
	...
	.replace(/((:D)|(:-D)|(XD))($|\s|<)/gi, emoteImage('biggrin', '$1', '$5'))
	...
	.replace(/((:-\))|(:\)))($|\s|<)/gi, emoteImage('smile', '$1', '$4'))
	...
	.replace(/((:-P)|(:P))($|\s|<)/gi, emoteImage('tongue', '$1', '$4'))
	.replace(/((:-\()|(:\())($|\s|<)/gi, emoteImage('unhappy', '$1', '$4'))
	.replace(/((;-\))|(;\)))($|\s|<)/gi, emoteImage('wink', '$1', '$4'))
